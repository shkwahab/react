...
class Blogsingleleftsidebar extends Component{
	render(){
		return(
				...
				<div className="dlab-bnr-inr overlay-black-middle bg-pt" style={{backgroundImage:"url(" + img + ")"}}>
					<div className="container">
						<div className="dlab-bnr-inr-entry">
							<h1 className="text-white">Blog single with left sidebar</h1>
											...
											<div className="comment-respond" id="respond">
												...
												<form className="comment-form" id="commentform" method="post" action="http://sedatelab.com/developer/donate/wp-comments-post.php">
													<p className="comment-form-comment">
														...
														<textarea rows="8" defaultValue placeholder="Comment" id="comment"></textarea>
													</p>
													<p className="comment-form-author">
														<label htmlFor="author">Name <span className="required">*</span></label>
														<input type="text" defaultValue="" placeholder="Author" id="author" />
													</p>
													...
													<p className="comment-form-url">
														...
														<input type="text"  defaultValue=""  placeholder="Website"  id="url" />
													</p>
													<p className="form-submit">
														<input type="submit" defaultValue="Post Comment" className="btn btnhover" id="submit" />
													</p>
												</form>
											</div>
...
export default Blogsingleleftsidebar;