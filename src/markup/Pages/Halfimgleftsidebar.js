...
class Halfimgleftsidebar extends Component{
	render(){
		return(
			<>
			<Header />
				...
				<div className="dlab-bnr-inr overlay-black-middle bg-pt" style={{backgroundImage:"url(" + img + ")"}}>
					<div className="container">
						<div className="dlab-bnr-inr-entry">
							<h1 className="text-white">Blog half image with left sidebar</h1>
							
							<div className="breadcrumb-row">
								<ul className="list-inline">
									<li><Link to={'./'}>Home</Link></li>
									<li>Blog half image with left sidebar</li>
								</ul>
							</div>
...
export default Halfimgleftsidebar;